        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                switch (choice)
                {
                    ...
                    case "2":
                        decimal increase = ReadDecimal("Enter amount to increase price in decimal format: ");
                        product.IncreasePrice(increase);
                        Console.WriteLine("Price updated: " + product);
                        break;

                    case "3":
                        decimal decrease = ReadDecimal("Enter amount to decrease price in decimal format: ");
